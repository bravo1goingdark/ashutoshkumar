...
const ogSvg = `<svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="960" y="412" font-family="'Courier New',Courier,monospace" font-size="11"
        fill="#57534e" letter-spacing="3">LATENCY CUT</text>
  <text x="960" y="428" font-family="'Courier New',Courier,monospace" font-size="10"
        fill="#44403c">Bindisa internship</text>

  <!-- Bottom bar -->
  <rect x="0" y="543" width="1200" height="87" fill="#18120e"/>
  <circle cx="96" cy="586" r="5" fill="#34d399"/>
  ...
  <text x="1128" y="592" font-family="'Courier New',Courier,monospace" font-size="13"
        fill="#57534e" text-anchor="end">ashutoshk.pages.dev</text>
</svg>`;
